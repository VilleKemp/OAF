...
def openapi3(json):
    ...
    #Parsing for interesting fields
    ...
    #Validation
    if(paths== None or info== None or openapi== None):
    ...
    #This variable contains all the schemas. It will be updated in the handle_ref function if any of the $ref components
    #reference a schema that wasn't in the schema object
    schemas = components.get("schemas")

    #Api object creation. 
    logging.info("Generating api object")
    api=API(json.get("openapi"),json.get("info"), None,None,json.get("components"),json.get("security"),json.get("tags"))
